    ...
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top text-muted lh-lg" style={{ fontSize: "1.2em" }}>
        <div className="col-6 p-5">
          <p>We kick-started operations on the 15th of August, 2025 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company Tradiq.</p>
