...
function ProductsPage() {
  return (
    <>
      ...
      <RightSection imageUrl="media/images/console.png" productName="Console" productDescrption="The central dashboard for your Tradiq account. Gain insights into your trades and investments with in-depth reports and visualisations." />
